...
- Simple WAN refiner workflow which can be used after LTX main run and upscaler: [Experiment_upscaler_wrapper](workflows/ltx/Experiment_upscaler_wrapper.json)
