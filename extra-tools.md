...
RIFE VFI still good to double frame rate with `rife49.pth`.
One implementation: `FL RIFE Frame Interpolation` from [GH:filliptm/ComfyUI_Fill-Nodes](https://github.com/filliptm/ComfyUI_Fill-Nodes).
